...
export const cardData = [
  ...
  },
  {
    ...
    description: "Biothon brings young medical and engineering talent together to identify issues, problems, and solutions for affordable healthcare ecosystems, medical equipment, and infrastructure.",
    header: <Skeleton />,
    className: "h-4 w-4",
  ...
  },
  {
    ...
    src: "/img/tracks/ctf.jpg",
    description: "Women entrepreneurship is a track dedicated to empowering women entrepreneurs, fostering innovative business ideas, and providing mentorship for female-led startups.",
    header: <Skeleton />,
    className: "h-4 w-4",
  ...
  },
  {
    ...
    description: "Think-Biz at Hack MIT-WPU'25 challenges aspiring entrepreneurs to innovate a product or service within set themes. Focusing on creativity, strategy, and critical thinking, it helps participants explore entrepreneurship while tackling real-world challenges",
    header: <Skeleton />,
    className: "h-4 w-4",
    // psUrl: "/tracks/Biothon ps.pdf",
  ...
  },
  {
    ...
    description: "A creative challenge where participants brainstorm and develop innovative solutions to real-world problems using cutting-edge technologies and design thinking.",
    header: <Skeleton />,
    className: "h-4 w-4",
  ...
  },
  {
    ...
    src: "/img/tracks/POLYTECH.png",
    description: "A hands-on event focused on practical problem-solving, where participants collaborate to build and implement tech-driven projects, pushing their technical skills to new heights.",
    header: <Skeleton />,
    className: "h-4 w-4",
